...
namespace AlphaBIM
{
    ...
    public class Lesson13_FormworkAreaCmd : IExternalCommand
    {
            ...
            ref string message, ElementSet elements)
        {
            ...
            {
                tranG.Start("Formwork Area");

                FormworkAreaViewModel viewModel
                    = new FormworkAreaViewModel(uidoc);

                FormworkAreaWindow window
                    = new FormworkAreaWindow(viewModel);
